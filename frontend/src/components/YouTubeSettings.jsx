...
function YouTubeSettings() {
    ...
    const getActionBadge = (action) => {
        if (action === 'hidden') return { icon: '', text: 'Hidden', className: 'yt-badge-hidden' };
        if (action === 'skipped') return { icon: '⏭', text: 'Skipped', className: 'yt-badge-skipped' };
                                        ...
                                        {autoReplyLog.map((entry, i) => {
                                            ...
                                            return (
                                                <div key={entry.commentId + '-' + i} className="yt-log-entry">
                                                    ...
                                                    <p className="yt-log-reply">↩ "{entry.replyText}"</p>
